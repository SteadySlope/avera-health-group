  ...
  return (
    <>
      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-pink-100 via-rose-50 to-pink-50 py-20 lg:py-28">
        ...
        <div className="container relative">
          <div className="mx-auto max-w-3xl text-center">
            <p className="mb-4 font-script text-2xl text-pink-500">Schedule Your Visit</p>
            <h1 className="mb-6 font-heading text-5xl font-bold text-gray-800 md:text-6xl">
              Book a <span className="text-pink-600">Consultation</span>
            </h1>
          ...
          <div className="grid gap-12 lg:grid-cols-2 lg:gap-16">
            ...
            <div className="rounded-3xl bg-gradient-to-br from-pink-50 to-rose-50 p-8 shadow-xl lg:p-10">
              ...
              <form className="space-y-5">
                ...
                <div className="space-y-2">
                  <Label htmlFor="visitType" className="text-gray-700">Type of Visit *</Label>
                  <select
                    id="visitType"
                    name="visitType"
                    className="flex h-10 w-full rounded-xl border border-pink-200 bg-white px-3 py-2 text-sm focus:border-pink-400 focus:outline-none focus:ring-2 focus:ring-pink-400/20"
                    required
                  >
                ...
                <div className="space-y-2">
                  <Label htmlFor="preferredDate" className="text-gray-700">Preferred Date</Label>
                  <Input
                    id="preferredDate"
                    name="preferredDate"
                    type="date"
            ...
            <div className="space-y-6">
              {/* Visit Types */}
              <div>
                <h2 className="mb-4 font-heading text-xl font-bold text-gray-800">Types of Visits</h2>
                <div className="space-y-4">
                  {visitTypes.map((type, index) => (
                    ...
                    >
                      <h3 className="mb-1 font-semibold text-gray-800">{type.title}</h3>
              ...
              {/* What to Expect */}
              <div className="rounded-2xl bg-gradient-to-br from-pink-50 to-rose-50 p-6 shadow-lg">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <a href={`tel:${company.phone}`}>
                      <Button className="rounded-full bg-white px-6 text-pink-600 hover:bg-pink-50">
              ...
              {/* Hours */}
              <div className="rounded-2xl bg-gradient-to-br from-pink-50 to-rose-50 p-6 shadow-lg">
                <h3 className="mb-4 flex items-center gap-2 font-heading text-xl font-bold text-gray-800">
      ...
      <section className="bg-gradient-to-br from-pink-50 to-rose-50 py-20 lg:py-28">
        <div className="container">
          <div className="mx-auto max-w-3xl text-center">
            <h2 className="mb-6 font-heading text-3xl font-bold text-gray-800">
