    ...
    <>
        ...
        <div className="container relative">
          <div className="grid gap-12 lg:grid-cols-2">
            <div className="flex flex-col justify-center">
              ...
              <p className="mb-4 font-script text-2xl text-sage-600">Family Medicine</p>
              <h1 className="mb-6 font-heading text-5xl font-bold text-warm-800 md:text-6xl">
                Care for <span className="text-sage-600">Every Generation</span>
              </h1>
            ...
            <div className="relative">
              <div className="relative aspect-[4/3] overflow-hidden rounded-3xl shadow-xl">
                <Image
                  src="/Family-Medical.png"
                  alt="Family Medicine at Averra Medical Group"
                  fill
      ...
      <section className="bg-gradient-to-br from-cream-50 to-sage-50 py-20 lg:py-28">
        <div className="container">
          <div className="grid gap-12 lg:grid-cols-2">
            <div>
              <p className="mb-3 font-script text-2xl text-sage-600">Care for Everyone</p>
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              {[
                ...
                >
                  <p className="text-3xl font-bold text-sage-600">{stat.value}</p>
      ...
      <section className="bg-white py-20 lg:py-28">
        <div className="container">
          <div className="mx-auto max-w-3xl">
            <div className="mb-12 text-center">
              <p className="mb-3 font-script text-2xl text-sage-600">Common Conditions</p>
              <h2 className="font-heading text-4xl font-bold text-warm-800">
                Conditions We Treat
              </h2>
            </div>
            <div className="grid gap-4 sm:grid-cols-2">
              {[
                ...
                >
                  ...
                  <span className="text-warm-700">{condition}</span>
                </div>
              ))}
            </div>
          </div>
